...
class TestRunner:
    """Professional test runner for the NLP SPAM DETECTION ML Pipeline with crypto support."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run technical validation tests for NLP SPAM DETECTION ML Pipeline",
...
Examples:
  ...
  python scripts/run_tests.py --no-proof         # Skip proof generation
    ...
    # Print header
    runner.print_header("NLP SPAM DETECTION ML Pipeline - Test Runner with Crypto Verification")
